...
export default class GameMain extends Component {
  constructor(props) {
    ...
    this.set_cell_content = this.set_cell_content.bind(this);
  }
  ...
  render_cell(i) {
    let cellClass = classNames({
      vbrd: ['c2', 'c5', 'c8'].includes(i),
      hbrd: ['c4', 'c5', 'c6'].includes(i),
      disabled: !this.state.game_play,
    });

    console.log(this.state.game_play);
  ...
  render() {
    ...
    return (
      <div id="GameMain">
        ...
        <button type="submit" onClick={this.end_game} className="button">
          <span>
